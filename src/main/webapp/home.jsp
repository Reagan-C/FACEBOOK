    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="fix">
                <div>
                    <img src="image/CJ.jpeg" href="image/CJ.jpeg" class="pix" alt=""/>
                    <p class="yourfeed"><%=user.getFirstName() + " " + user.getLastName() %>
                    </p>
                </div>
                <div class="yourfeed1">
                    <i class="fa fa-globe pictures" aria-hidden="true"></i>
        ...
        <div class="col-lg-6">
            <div class="scroller like-icon" style="height:  700px">
                ...
                <div class="linear" style="background-color: #ffffff">
                    <div class="titleText">
                        <h4 style="color: #012a0e; padding: 10px; background-color: dodgerblue"><%=each.getTitle()%>
                            &nbsp; by &nbsp; <span><%=each.getName()%></span></h4>
                    </div>
                ...
                <div class="comment_like_share mb-2">
                    <div class="like">
                        ...
                        <i onclick="like(<%=each.getId()%>, <%=user.getId()%>)" id="<%=each.getId()%>"
                           style="color: #ffffff" class="fa fa-thumbs-up" aria-hidden="true">
                            <span class="likes"><%=each.getNoLikes()%></span>
                            <span style="display:none;" class="thumb"><%=each.getId()%></span></i>
                        <p style="display: none" class="userLiked"><%=each.isLikedPost()%>
                        </p>

                    </div>
                    <div class="comment">
                        <%--                                        <i class="fa fa-commenting" aria-hidden="true"></i>--%>
                        <i class="fa fa-commenting" aria-hidden="true" onclick="com(<%=each.getId()%>)">
                            <span><%=each.getNoComments()%></span>
                        </i>
                    </div>
                    <div class="edit">
                        <%--                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>--%>
                        <i class="fa fa-pencil-square-o" aria-hidden="true" onclick="edit(<%=each.getId()%>)">
                        </i>
                    </div>
                    <div class="delete">
                        <%--                                        <i class="fa fa-times" aria-hidden="true"></i>--%>
                        <i class="fa fa-times" aria-hidden="true" id="delete" onclick="del(<%=each.getId()%>)">
                        </i>
                    </div>
                </div>
                <div class="row mb-2">
